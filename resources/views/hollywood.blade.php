...
<div class="container-fluid py-5 bg-dark text-white">
    <div class="px-4 py-5 text-center">
        <h1 class="display-5 fw-bold" style="font-family: 'Rubik', sans-serif;">Hollywood Movies</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4" style="font-family: 'Poppins', sans-serif;">Download & Stream Best Hollywood movies in best 1080p completely free.</p>
...
<div class="container-fluid mt-5">
    <div class="row">
        <div class="col-sm-3">
            ...
            <p align="center"><a href="{{'/category/'.$cat['id'].'/hollywood'}}">{{$cat['title']}}</a></p>
            @endforeach
        </div>
        <div class="col-sm-9">
